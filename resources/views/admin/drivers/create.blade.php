...
@section('content')
    ...
    <div class="md:flex block items-center justify-between my-6 page-header-breadcrumb">
        <div>
            <h4 class="mb-0 text-defaulttextcolor font-medium">Register Driver</h4>
            <p class="-mt-[0.2rem] mb-0 text-textmuted">Add a new Driver to the system</p>
        </div>
                        ...
                        <div class="space-y-4">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" class="ti-form-input @error('first_name') !border-red-500 @enderror" id="first_name" name="first_name" placeholder="First Name" value="{{ old('first_name') }}">
                                    @error('first_name')
                                ...
                                <div>
                                    ...
                                    <input type="text" class="ti-form-input @error('last_name') !border-red-500 @enderror" id="last_name" name="last_name" placeholder="Last Name" value="{{ old('last_name') }}">
                                    @error('last_name')
                                        <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                    @enderror
                                </div>
                            ...
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('license_number') !border-red-500 @enderror" id="license_number" name="license_number" placeholder="License Number" value="{{ old('license_number') }}">
                                ...
                                <div>
                                    ...
                                    <select class="ti-form-select @error('toda_id') !border-red-500 @enderror" id="toda_id" name="toda_id">
                                        ...
                                        @foreach($todas as $toda)
                                            <option value="{{ $toda->id }}" {{ old('toda_id') == $toda->id ? 'selected' : '' }}>{{ $toda->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('toda_id')
                                        <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                ...
                                <div>
                                    ...
                                    <select class="ti-form-select @error('tricycle_id') !border-red-500 @enderror" id="tricycle_id" name="tricycle_id">
                                        ...
                                        @foreach($tricycles as $tricycle)
                                            <option value="{{ $tricycle->id }}" {{ old('tricycle_id') == $tricycle->id ? 'selected' : '' }}>{{ $tricycle->body_number }} ({{ $tricycle->plate_number }})</option>
                                        @endforeach
                                    </select>
                                    @error('tricycle_id')
                                        <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                            ...
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('contact_number') !border-red-500 @enderror" id="contact_number" name="contact_number" placeholder="Contact Number" value="{{ old('contact_number') }}">
                            ...
                            <div>
                                ...
                                <textarea class="ti-form-input @error('address') !border-red-500 @enderror" id="address" name="address" rows="3" placeholder="Address">{{ old('address') }}</textarea>
                                @error('address')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
