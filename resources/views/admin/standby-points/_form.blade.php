...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 space-y-5">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                <label for="latitude" class="block text-sm font-medium text-slate-700 dark:text-slate-200">Latitude <span class="text-rose-600">*</span></label>
                <input
                    id="latitude"
                    name="latitude"
                    type="number"
                    step="0.0000001"
                    value="{{ old('latitude', $standbyPoint->latitude ?? '') }}"
                    class="mt-1 w-full px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-primary focus:border-primary font-mono @error('latitude') border-rose-400 @enderror"
            ...
            <div>
                <label for="longitude" class="block text-sm font-medium text-slate-700 dark:text-slate-200">Longitude <span class="text-rose-600">*</span></label>
                <input
                    id="longitude"
                    name="longitude"
                    type="number"
                    step="0.0000001"
                    value="{{ old('longitude', $standbyPoint->longitude ?? '') }}"
                    class="mt-1 w-full px-4 py-2.5 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-700 rounded-lg text-sm focus:ring-primary focus:border-primary font-mono @error('longitude') border-rose-400 @enderror"
            ...
            <div class="mt-4 space-y-4">
                <div>
                    ...
                    <input
                        ...
                        min="1"
                        max="2000"
                        value="{{ old('radius_meters', $standbyPoint->radius_meters ?? 50) }}"
