...
@section('content')
    ...
    <div class="md:flex block items-center justify-between my-6 page-header-breadcrumb">
        <div>
            <h4 class="mb-0 text-defaulttextcolor font-medium">Edit TODA</h4>
            <p class="-mt-[0.2rem] mb-0 text-textmuted">Update TODA Information</p>
        </div>
                    ...
                    <form action="{{ route('todas.update', $toda->id) }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('name') !border-red-500 @enderror" id="name" name="name" placeholder="Enter TODA Name" value="{{ old('name', $toda->name) }}">
                                @error('name')
                            ...
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('area_coverage') !border-red-500 @enderror" id="area_coverage" name="area_coverage" placeholder="e.g. Brgy. Poblacion, Brgy. Osias" value="{{ old('area_coverage', $toda->area_coverage) }}">
                                @error('area_coverage')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('operating_hours') !border-red-500 @enderror" id="operating_hours" name="operating_hours" placeholder="e.g. 5:00 AM - 10:00 PM" value="{{ old('operating_hours', $toda->operating_hours) }}">
