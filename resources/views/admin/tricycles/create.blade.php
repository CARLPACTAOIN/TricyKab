...
@section('content')
    ...
    <div class="md:flex block items-center justify-between my-6 page-header-breadcrumb">
        <div>
            <h4 class="mb-0 text-defaulttextcolor font-medium">Register Tricycle</h4>
            <p class="-mt-[0.2rem] mb-0 text-textmuted">Add a new Tricycle to the fleet</p>
        </div>
                    ...
                    <form action="{{ route('tricycles.store') }}" method="POST">
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('body_number') !border-red-500 @enderror" id="body_number" name="body_number" placeholder="Enter Body Number" value="{{ old('body_number') }}">
                                @error('body_number')
                            ...
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('plate_number') !border-red-500 @enderror" id="plate_number" name="plate_number" placeholder="Enter Plate Number" value="{{ old('plate_number') }}">
                                @error('plate_number')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
                            ...
                            <div>
                                ...
                                <input type="text" class="ti-form-input @error('make_model') !border-red-500 @enderror" id="make_model" name="make_model" placeholder="e.g. Honda TMX 155" value="{{ old('make_model') }}">
                                @error('make_model')
                                    <p class="text-sm text-red-500 mt-1">{{ $message }}</p>
                                @enderror
                            </div>
