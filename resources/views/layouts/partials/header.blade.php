    ...
    <nav class="main-header" aria-label="Global">
        <div class="main-header-container !px-[0.85rem]">
            ...
            <div class="header-content-right">
                ...
                <!-- Header Profile -->
                <div class="header-element md:!px-[0.5rem] px-2 hs-dropdown profile-dropdown !items-center ti-dropdown [--placement:bottom-left]">
                    ...
                    <button id="dropdown-profile" type="button"
                        ...
                        <img class="inline-block rounded-full " src="{{ asset('assets/images/faces/6.jpg') }}" width="37"
                        ...
                        <ul class="dropdown-menu pt-0 header-profile-dropdown dropdown-menu-end main-profile-menu"
                            ...
                            <li>
                                <div class="main-header-profile bg-primary menu-header-content text-white">
                                    <div class="my-auto">
                                        <h6 class="mb-0 leading-none text-white">{{ Auth::user()->name ?? 'Admin' }}</h6>
                                        <span class="text-[.6875rem] opacity-[0.7] leading-none">Administrator</span>
                                    </div>
                                </div>
                            </li>
                            <li>
                                <a class="dropdown-item text-defaulttextcolor flex" href="{{ route('profile.edit') }}">
                                    <i class="bx bx-user-circle text-[1.125rem] me-2 opacity-[0.7]"></i>Profile
                                </a>
                            </li>
                            <li>
                                <a class="dropdown-item text-defaulttextcolor flex" href="{{ route('profile.edit') }}">
                                    <i class="bx bx-cog text-[1.125rem] me-2 opacity-[0.7]"></i>Edit Profile
                                </a>
                            </li>
                            <li>
                                <form method="POST" action="{{ route('logout') }}">
                                    @csrf
                                    <a class="dropdown-item text-defaulttextcolor !rounded-bl-md !rounded-br-md flex" href="{{ route('logout') }}"
